...
const Login = () => {
  ...
  if (isMobile) {
    ...
    styles.imageSection = { ...styles.imageSection, flex: "none", width: "100%" };
    styles.formSection = { ...styles.formSection, flex: "none", width: "100%" };
  }
    ...
    <div style={styles.body}>
      <div style={styles.container}>
        ...
        <div style={styles.formSection}>
          ...
          <div
            style={{ ...styles.formGroup, display: "flex", justifyContent: "space-between" }}
          >
